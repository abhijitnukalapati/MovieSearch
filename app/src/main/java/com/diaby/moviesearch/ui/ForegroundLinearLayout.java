...
/**
 * A LinearLayout Subclass that adds support to draw
 * a foreground. This is especially helpful
 * when it has ImageView as a child and touch
 * feedback is required
 *
 * Taken from https://goo.gl/4Cf7bB
 */
